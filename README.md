...
- [Live Demo Link](https://francis3400.github.io/leaderboard-app/dist/)
...
Clone this repository to your desired folder:
  ...
  3. Run: 
      ```sh
        git clone https://francis3400.github.io/leaderboard-app.git          
      ```
